...
from error import NothingToModifyException, FailedToExtractCreditNotesException, PathNotFoundException, \
    PathNotPDFFileException
from pdf import open_pdf_document, get_pages_with_credit_notes, replace_matches_in_pdf
...
def home():
    ...
    } for f in OUTPUT_DIR.iterdir() if f.is_file() and f.suffix == ".pdf"]
